                                ...
                                HStack(spacing: 0) {
                                    ...
                                    case "Int":
                                        Text("\(processor.driverDatabase[key]?.IntervalToPositionAhead ?? "")")
                                            ...
                                            .foregroundColor(Color.white)
                                    case "Tyre":
                                        Text("\(processor.driverDatabase[key]?.TyreAge ?? 0)")
                                            .padding(.vertical, 8)
                                            .padding(.leading, 8)
                                            .foregroundColor(Color.white)
                                    ...
                                    case "Sector 3":
                                        Text("\(processor.driverDatabase[key]?.Sector3Time ?? "")")
                                            ...
                                            .foregroundColor(Color.white)
                                    case "ST1":
                                        Text("\(processor.driverDatabase[key]?.Sector1SpeedTrap ?? 0)")
                                            .padding(8)
                                            .foregroundColor(Color.white)
                                    case "ST2":
                                        Text("\(processor.driverDatabase[key]?.Sector2SpeedTrap ?? 0)")
                                            .padding(8)
                                            .foregroundColor(Color.white)
                                    case "ST3":
                                        Text("\(processor.driverDatabase[key]?.FinishLineSpeedTrap ?? 0)")
                                            .padding(8)
                                            .foregroundColor(Color.white)
                                    case "Pit":
